...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            model._region0_Intersection_Light_t = item->valuedouble;
        }
...
void sendVariables(int send_interface) {
    ...
    cJSON_AddItemToObject(root, "_region0_Intersection_Light_t", cJSON_CreateNumber(model._region0_Intersection_Light_t));
